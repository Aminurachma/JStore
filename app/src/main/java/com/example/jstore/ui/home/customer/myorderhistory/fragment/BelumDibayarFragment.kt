...
import com.example.jstore.databinding.FragmentBelumDibayarBinding
...
class BelumDibayarFragment : BaseFragment() {
    ...
    override fun onCreateView(
        ...
        _binding = FragmentBelumDibayarBinding.inflate(layoutInflater)
        return binding?.root
    }
