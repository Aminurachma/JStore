...
import com.example.jstore.databinding.FragmentDiterimaBinding
...
class DiterimaFragment : BaseFragment() {
    ...
    override fun onCreateView(
        ...
        _binding = FragmentDiterimaBinding.inflate(layoutInflater)
        return binding?.root
    }
