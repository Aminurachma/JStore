...
import com.example.jstore.databinding.FragmentDikemasBinding
...
class DikemasFragment : BaseFragment() {
    ...
    override fun onCreateView(
        ...
        _binding = FragmentDikemasBinding.inflate(layoutInflater)
        return binding?.root
    }
    ...
    private fun getMyOrderList() {
        progress.show()
        FirestoreClass().subscribeUserOrderHistory(Constants.DIKEMAS,
            onSuccessListener = {
                progress.dismiss()
                if (it.isNotEmpty()) {
